...
Ahora es necesario crear el aplicativo que se encontrará en el *web server*, mediante la línea de código `app = Flask(__name__)`. Lo configuramos para *Google Actions* con `app.config['ASSIST_ACTIONS_ON_GOOGLE'] = True` y `app.config['INTEGRATIONS'] = ['ACTIONS_ON_GOOGLE']`. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1OTk1ODQxMywxNDY5NzIyOTQ1LC0xMD
I0OTY0NzI5LC0xNjg4ODcwNzE0LDE0ODUzNTkyNzQsLTE3MzU1
NTExNDIsMTE1NTgyMjQyOSwtNjkxMTA0NjYxLC02OTkxMDAyNz
MsNTE4MTkzOTcxLC0xOTM2MjYzMzMxLDgyODA4OTQ0LC0xMDUx
ODQxOTgsNjI5NTY1MjYyLDIyMDIwNTk5NywxMzU4NDMwNjI0LD
gwMjQxNTk2OCw1MTI3MjM0NTksLTE3MzY5Mzc1NjMsMTU4Nzg1
NzE0OF19
-->