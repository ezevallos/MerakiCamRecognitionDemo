...
Debemos ingresar a [*Heroku Set up*](https://devcenter.heroku.com/articles/getting-started-with-python#set-up) y elegir nuestra plataforma 
## Rename a file
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgzMDgzNTA4OCwxMTUzNTI0OTA5LC0xMz
